Original codes by Takahiro Omi, adapted for the Romanian seismicity by Bogdan Enescu.
...
Important note: the code use Python 3.11 (e.g., 3.11.12).
...
Some packages (matplotlib, pandas, scipy, numpy) shoild be installed.

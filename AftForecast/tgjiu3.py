...
if __name__ == '__main__':
    ...
    #Periods
    t_learn = [0.0, 0.250]            # The range of the learning period [day]
    t_for   = [0.250, 0.500]          # The range of the testing period [day]

    #File with estimated parameters
    file_param = 'gorj_forecast_0h-6h_6h-12h.dat'
    ...
    mu_last = mu[-1]                               #Magnitude of detection at the end of the training window
